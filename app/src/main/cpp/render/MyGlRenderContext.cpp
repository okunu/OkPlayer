...
#include "base/TextureSample.h"
#include "CommonData.h"
#include "base/VaoSample.h"
#include "base/YuvSample.h"
#include "base/UniformSample.h"
#include "JniHelper.h"
#include "base/TwoTextureSample.h"
#include "base/TransformSample.h"
#include "base/CubeSample.h"
#include "base/ComplexCubeSample.h"
#include "light/SimpleLightSample.h"
#include "base/RorateSample.h"
#include "light/MaterialSample.h"
...
void MyGlRenderContext::initSampler(int type) {
    ...
    } else if (type == RenderType::MoreLight) {
